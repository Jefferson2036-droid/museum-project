...
describe("sitemap", () => {
  it("includes all known routes", () => {
    ...
    expect(urls.some((u) => u.includes("/eras/precursors-to-machine-intelligence"))).toBe(true);
    expect(urls.some((u) => u.includes("/eras/foundation-models-and-generative-ai"))).toBe(true);
