...
const era2Anchors = historicalAnchors.filter((anchor) => anchor.era === "Era 2");
...
export default function ComputationInformationFieldFormationPage() {
  return (
    <article className="hero-panel exemplar-panel chapter-theme chapter-theme--formation">
        ...
        >
          <div className="prose-block">
            <p>
              ...
              combines chronology, argument, diagram, source anchors,
              documentary cards, and concept teaching without dropping the
              historical thread.
            </p>
          </div>
          <EditorialAside
          ...
          >
            <p>
              The chapter becomes stronger when each precursor line keeps its
              own role instead of being compressed into a single heroic origin.
            </p>
          </EditorialAside>
        </ChapterHero>
        ...
        >
          <p>
            If Dartmouth is taught as a sudden beginning, students lose the
            deeper logic of the field. Era 2 works better when the naming moment
            is shown as the end of a buildup in computation, engineering,
            information, and neural abstraction.
          </p>
        </GuideCallout>

        <ChapterSection id="era-2-chronology" eyebrow="Chronology" title="Five anchor points">
        ...
        <ChapterSection id="era-2-narrative" eyebrow="Core Narrative" title="How the package teaches the era" prose>
          <div className="chapter-split">
            ...
            <EditorialAside label="Convergence Logic" title="Each strand does a different job in the origin package">
              <p>
        ...
        <ChapterSection id="era-2-visual" eyebrow="Visual Convergence" title="Why Dartmouth is a meeting point, not a lone origin">
          <LogicToAiDiagram />
        </ChapterSection>

        <ChapterSection id="era-2-story-layer" eyebrow="Documentary Story Layer" title="Two teaching cards that keep the convergence legible">
        ...
        <ChapterSection id="era-2-source-anchors" eyebrow="Source Anchors" title="Historical objects and source pages for the convergence story">
          <div className="documentary-grid documentary-grid--anchors">
            {era2Anchors.map((anchor) => (
              <NarrativeCard
                ...
                officialLink={{ href: anchor.officialUrl, label: anchor.officialLabel }}
        ...
        <ChapterSection id="era-2-people" eyebrow="Linked People" title="Who carries the story">
          <div className="content-grid">
        ...
        <ChapterSection id="era-2-concepts" eyebrow="Linked Concepts" title="The technical ideas students must meet">
        ...
        <ChapterSection id="era-2-turning-point" eyebrow="Institutions And Turning Point" title="Bell Labs and Dartmouth do different jobs">
          <div className="institution-grid">
            <article className="content-card">
              <h3>Bell Labs</h3>
              <p>
                Bell Labs gives the slice an institutional setting for
                Shannon&apos;s engineering work, which helps explain why logic
                and information are not just philosophical ideas in this story.
              </p>
            </article>
            <article className="content-card">
              <h3>
          ...
          >
            <p>
              ...
              organized and named a field that earlier work had already
              prepared.
            </p>
          </GuideCallout>
        </ChapterSection>

        <ChapterSection id="era-2-media" eyebrow="Media And Source Trail" title="Media and source trail for this era">
