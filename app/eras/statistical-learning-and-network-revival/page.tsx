    ...
    <article className="hero-panel exemplar-panel chapter-theme chapter-theme--statistical">
          ...
          links={[
            {
              ...
              label: "Back to Era 4: Knowledge Systems, Critique, And The First AI Winter",
            },
            {
        ...
        >
          <div className="prose-block">
            <p>
              The key educational move here is comparison: what do statistical
              and learned approaches promise that hand-built symbolic systems no
              longer seem able to provide at scale?
            </p>
          </div>
          <EditorialAside label="Method Shift" title="Probability changes what counts as a good explanation of intelligence">
            <p>
        ...
        >
          <p>
            ...
            noisy data, and large examples. That methodological shift is the
            real bridge out of the first winter.
          </p>
        </GuideCallout>

        <ChapterSection id="era-5-chronology" eyebrow="Chronology" title="Five anchor points">
        ...
        <ChapterSection id="era-5-narrative" eyebrow="Core Narrative" title="Why the field moves toward learning" prose>
          <div className="chapter-split">
            ...
            <EditorialAside label="Compare The Methods" title="Hand-built rules give way to learned features and measurable prediction">
              <p>
                This is why the chapter matters: it changes not only tools but
                the standards by which the field decides what counts as progress.
              </p>
            </EditorialAside>
          </div>
        </ChapterSection>

        <ChapterSection id="era-5-people" eyebrow="Linked People" title="Who carries the transition">
        ...
        >
          <p>
            ...
            statistics, corpora, benchmark culture, and revived neural methods
            all at once. Deep learning becomes dominant later, after this
            transition has already changed what AI researchers count as credible
            evidence.
          </p>
        </GuideCallout>

        <ChapterSection id="era-5-concepts" eyebrow="Linked Concepts" title="The methods that change the field">
          ...
          <p className="artifact-note">
            This era is the runway for deep learning rather than its full
            victory lap. By the end of Era 5, the field is primed to trust
            large-scale learning systems far more than it did during the
            symbolic and expert-systems period.
          </p>
        </ChapterSection>

        <ChapterSection id="era-5-institutions" eyebrow="Institutions And Milestones" title="Industrial research starts to matter differently">
          <div className="institution-grid">
            <article className="content-card">
              <h3>IBM Research</h3>
              <p>
                IBM keeps the era grounded in industrial AI milestones such as
                Deep Blue and Watson, where large-scale computation, ranking,
                and language systems become part of the public story of AI
                again.
              </p>
            </article>
            <article className="content-card">
          ...
          <p className="artifact-note">
            Era 5 ends by pointing directly toward a new question: once models
            can learn stronger internal representations from large data, what
            happens when those same systems scale further and language
            architectures change again?
          </p>
        </ChapterSection>
