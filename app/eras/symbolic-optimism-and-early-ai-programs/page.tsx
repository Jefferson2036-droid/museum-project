...
export default function SymbolicOptimismAndEarlyAiProgramsPage() {
  return (
    <article className="hero-panel exemplar-panel chapter-theme chapter-theme--symbolic">
          ...
          links={[
            {
              ...
              label: "Back to Era 2: Computation, Information, And Field Formation",
            },
            {
              href: "/eras/knowledge-systems-critique-and-the-first-ai-winter",
              label: "Continue to Era 4: Knowledge Systems, Critique, And The First AI Winter",
            },
          ]}
        >
          ...
          <EditorialAside label="Lab Mood" title="This is the chapter where AI starts to feel buildable">
            <p>
              Programs, languages, heuristics, and robotics make intelligence
              look programmable enough to justify large institutional ambition.
            </p>
          </EditorialAside>
        </ChapterHero>
        ...
        >
          <p>
            It is easy to look backward and treat the symbolic era as naive.
            That misses the point. Researchers in this period built concrete
            methods for search, reasoning, planning, and programming that still
            shape later AI and computer science.
          </p>
        </GuideCallout>

        <ChapterSection id="era-3-chronology" eyebrow="Chronology" title="Five anchor points">
        ...
        <ChapterSection id="era-3-narrative" eyebrow="Core Narrative" title="How the era teaches the field after Dartmouth" prose>
          <div className="chapter-split">
            ...
            <EditorialAside label="What They Thought Intelligence Was" title="Explicit representation plus symbolic manipulation">
              <p>
        ...
        <ChapterSection id="era-3-people" eyebrow="Linked People" title="Who carries the symbolic era">
        ...
        <ChapterSection id="era-3-concepts" eyebrow="Linked Concepts" title="The ideas that make the optimism intelligible">
        ...
        <ChapterSection id="era-3-institutions" eyebrow="Institutions And Pressure" title="Labs and funding shape the research style">
